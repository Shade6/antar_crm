...
export const create_lead_comment = async(data)=>{
  return (await axiosInstance.post(`create_lead_comment?mdl=${switchStore().pageId}&&lead_id=${data?.lead_id||null}`,data)).data
}
...
export const create_lead_note_attachment = async(data)=>{
  return (await axiosInstance.post(`create_lead_note_attachment?mdl=${switchStore().pageId}&&lead_id=${data?.lead_id||null}`,data)).data
}
...
export const create_lead_task = async(data)=>{
  return (await axiosInstance.post(`create_lead_task?mdl=${switchStore().pageId}&&lead_id=${data?.lead_id||null}`,data)).data
}
...
export const get_lead_activity = async(data)=>{
  return (await axiosInstance.get(`get_lead_activity?mdl=${switchStore().pageId}&&lead_id=${data}`)).data
}
...
export const create_contact = async(data)=>{
  return (await axiosInstance.post(`create_contact?mdl=${switchStore().pageId}`,data)).data
}

export const get_all_contact = async(data)=>{
  return (await axiosInstance.get(`get_contacts?mdl=${switchStore()?.pageId || ''}&&role=${data}`)).data
}

export const create_organization = async(data)=>{
  return (await axiosInstance.post(`create_organization?mdl=${switchStore().pageId}`,data)).data
}

export const get_all_organization = async(data)=>{
  return (await axiosInstance.get(`get_organization?mdl=${switchStore()?.pageId || ''}`)).data
}

export const create_address = async(data)=>{
  return (await axiosInstance.post(`create_address?mdl=${switchStore().pageId}`,data)).data
}

export const get_all_address = async(data)=>{
  return (await axiosInstance.get(`get_address?mdl=${switchStore().pageId}`)).data
}

export const delete_contact = async(data)=>{
  const formattedData = Array.from(data).join(',');
  return (await axiosInstance.delete(`delete_contact?mdl=${switchStore().pageId}&&id=${formattedData}`)).data
}
