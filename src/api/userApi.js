...
// create
export const create_basic_attachments = async (data) => {
  return (
    await axiosInstance.post(
      `create_basic_attachments?mdl=${switchStore().pageId}`,
      data
    )
  ).data;
};
export const create_basic_comments = async (data) => {
  return (
    await axiosInstance.post(
      `create_basic_comments?mdl=${switchStore().pageId}`,
      data
    )
  ).data;
};
...
export const create_basic_notes = async (data) => {
  return (
    await axiosInstance.post(
      `create_basic_notes?mdl=${switchStore().pageId}`,
      data
    )
  ).data;
};
...
export const create_basic_task = async (data) => {
  return (
    await axiosInstance.post(
      `create_basic_task?mdl=${switchStore().pageId}`,
      data
    )
  ).data;
};
...
export const get_all_basic_comments = async (data) => {
  return (
    await axiosInstance.get(
      `get_all_basic_comments?mdl=${switchStore().pageId}&&lead_id=${data.lead_id}&&opportunity_id=${data.opportunity_id}`
    )
  ).data;
};
export const get_all_basic_attachments = async (data) => {
  return (
    await axiosInstance.get(
      `get_all_basic_attachments?mdl=${switchStore().pageId}&&lead_id=${data.lead_id}&&opportunity_id=${data.opportunity_id}`
    )
  ).data;
};
export const get_all_basic_notes = async (data) => {
  return (
    await axiosInstance.get(
      `get_all_basic_notes?mdl=${switchStore().pageId}&&lead_id=${data.lead_id}&&opportunity_id=${data.opportunity_id}`
    )
  ).data;
};
export const get_all_basic_task = async (data) => {
  return (
    await axiosInstance.get(
      `get_all_basic_task?mdl=${switchStore().pageId}&&lead_id=${data.lead_id}&&opportunity_id=${data.opportunity_id}`
    )
  ).data;
};

// delete
export const update_basic_attachments = async (data) => {
  return (
    await axiosInstance.put(`update_basic_attachments?mdl=${switchStore().pageId}`, data)
  ).data;
};
export const update_basic_comments = async (data) => {
  return (
    await axiosInstance.put(`update_basic_comments?mdl=${switchStore().pageId}`, data)
  ).data;
};
export const update_basic_task = async (data) => {
  return (
    await axiosInstance.put(`update_basic_task?mdl=${switchStore().pageId}`, data)
  ).data;
};
export const update_basic_notes = async (data) => {
  return (
    await axiosInstance.put(`update_basic_notes?mdl=${switchStore().pageId}`, data)
  ).data;
};

// delete

export const delete_basic_attachments = async (data) => {
  return (
    await axiosInstance.delete(
      `delete_basic_attachments?mdl=${switchStore().pageId}&&id=${data}`
    )
  ).data;
};
export const delete_basic_comments = async (data) => {
  return (
    await axiosInstance.delete(
      `delete_basic_comments?mdl=${switchStore().pageId}&&id=${data}`
    )
  ).data;
};
export const delete_basic_notes = async (data) => {
  return (
    await axiosInstance.delete(
      `delete_basic_notes?mdl=${switchStore().pageId}&&id=${data}`
    )
  ).data;
};
export const delete_basic_task = async (data) => {
  return (
    await axiosInstance.delete(
      `delete_basic_task?mdl=${switchStore().pageId}&&id=${data}`
    )
  ).data;
};
