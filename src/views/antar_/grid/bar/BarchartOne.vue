...
import {find_dashboard_new_lead} from "@/api/userApi"
...
const handle_timeFrame = async (data) => {
  const res = await find_dashboard_new_lead(data);
...
<template>
 <div class="border p-4 h-full w-full">
    ...
    <div class="flex justify-between px-3 py-2">
      <span class="font-bold"><u>New Lead Created</u> </span>
      <Dropdown
        class=""
        :options="[
          {
