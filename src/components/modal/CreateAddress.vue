<template>
      ...
      <Dialog  v-model="dialog2">
        ...
        <template #body-content>
          <div class="flex justify-between my-2">
            <div class="w-[48%]">
                <span class="text-gray-500 font-medium text-sm my-1">Address Title</span>
              <TextInput
            ...
            <div class="w-[48%]">
                <span class="text-gray-500 font-medium text-sm my-1">Address Type</span>
                <TextInput
          ...
          <div class="flex justify-between my-2">
            <div class="w-[48%]">
                <span class="text-gray-500 font-medium text-sm my-1">Address line one</span>
              <TextInput
            ...
            <div class="w-[48%]">
                <span class="text-gray-500 font-medium text-sm my-1">Address line two</span>
                <TextInput
          ...
          <div class="flex justify-between my-2">
            <div class="w-[48%]">
                <span class="text-gray-500 font-medium text-sm my-1">city/town</span>
              <TextInput
            ...
            <div class="w-[48%]">
                <span class="text-gray-500 font-medium text-sm my-1">State/Province</span>
                <TextInput
          ...
          <div class="flex justify-between my-2">
            ...
            <div class="w-[48%]">
                <span class="text-gray-500 font-medium text-sm my-1">Postal Code</span>
                <TextInput
        ...
        <template class="flex justify-end" #actions>
          <div class="flex justify-end">
            <Button class="" variant="solid" @click="createAddress_save"> create </Button>
          </div>
        </template>
      </Dialog>
    </div>
  ...
  import {create_address} from "@/api/userApi.js"
...
const toast = useToast();
  ...
  const createAddress_save = async () => {
    const res = await create_address(form_values.value)
