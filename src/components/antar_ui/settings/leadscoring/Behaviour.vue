...
watch(
  ...
  (newData) => {
    if (Object.keys(newData).length > 0) {
      selected_lead.value = {
        website_visits: newData.selected?.website_visits || null,
        email_interaction: newData.selected?.email_interaction || null,
        content_engagement: newData.selected?.content_engagement || null,
      };

      value_selected_lead.value = {
        value_of_website_visits:
          newData.values?.value_of_website_visits || null,
        value_of_email_interaction:
          newData.values?.value_of_email_interaction || null,
        value_of_content_engagement:
          newData.values?.value_of_content_engagement || null,
      };
    }
  },
        ...
        <tbody class="font-light">
          <tr>
            ...
            <Autocomplete
                ...
                :multiple="true"
                :unique="true"
                placeholder="Select website visits"
                :options="[
                  {
                    label: 'empty',
                    value: '1-10',
          ...
          <tr>
            ...
            <Autocomplete
                class="bg-white"
                placeholder="Select email interaction"
                :multiple="true"
                :unique="true"
                :options="[
                  {
          ...
          <tr>
            ...
            <Autocomplete
                ...
                :multiple="true"
                :unique="true"
                placeholder="Select content engagement"
                :options="[
                  {
                    label: 'empty',
                    value: '1-10',
