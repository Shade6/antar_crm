    ...
    if (Object.keys(newData).length > 0) {
      selected_lead.value = {
        qualified_or_unqualified_lead:
          newData.selected?.qualified_or_unqualified_lead || null,
      };

      value_selected_lead.value = {
        value_of_qualified_or_unqualified_lead:
          newData.values?.value_of_qualified_or_unqualified_lead || null,
      };
    }
  },
        ...
        <tbody>
          <tr>
            ...
            <Autocomplete
                ...
                :multiple="true"
                :unique="true"
                placeholder="Select qualified or unqualified lead"
                :options="[
                  {
                    label: 'empty',
                    value: '1-10',
            ...
            >
              <div class="">
                <TextInput
                  ...
                  :disabled="false"
                  :modelValue="
                    value_selected_lead.value_of_qualified_or_unqualified_lead
                  "
                  v-model="
                    value_selected_lead.value_of_qualified_or_unqualified_lead
                  "
