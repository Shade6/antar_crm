...
<template>
    ...
    <div class="p-1">
      ...
      >
        <div class="flex justify-start">
          <FeatherIcon class="w-4" name="plus" /> <span>New Task</span>
        </div>
      </Button>
    </div>
  </div>
    ...
    <div v-else>
      ...
      >
        <div>
          ...
          <span style="height: 5px;width: 5px;" class=" my-auto bg-gray-600 rounded-full mx-2"></span>
  ...
  <div v-else class="w-full">
    <div class="w-[500px] h-[500px] border mx-auto p-4">
      <div class="p-4 text-center">
        <span class="text-3xl">Create Task</span>
      </div>
      <div class="my-2">
