module.exports = (app) => {
  ...
  router.post(
    ...
    controller.create_module_permission
  );
  router.put(
    "/update_docs_permission",
    Authenticator.user,
    Subscription.check_subscription,
    controller.update_docs_permission
  );
  router.get(
    "/get_docs_permission",
    Authenticator.user,
    Subscription.check_subscription,
    controller.get_docs_permission
  );
  router.get(
    ...
    controller.find_all_docs_permission
  );
  router.get(
    "/find_all_role_permissions",
    Authenticator.user,
    Subscription.check_subscription,
    AccessChecker.access_read,
    controller.find_all_role_permissions
  );
  router.put(
    "/permission_giver",
    Authenticator.user,
